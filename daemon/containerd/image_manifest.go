...
func (i *ImageService) walkReachableImageManifests(ctx context.Context, img images.Image, handler func(img *ImageManifest) error) error {
	desc := img.Target
	...
	if images.IsIndexType(desc.MediaType) {
		return images.Walk(ctx, images.HandlerFunc(
			func(ctx context.Context, desc ocispec.Descriptor) ([]ocispec.Descriptor, error) {
				...
				descs, err := images.Children(ctx, i.content, desc)
				if err != nil {
