...
replace (
	github.com/containerd/containerd/v2 => github.com/macOScontainers/containerd/v2 v2.0.0-20240218142517-4e59b5b68c3e
	github.com/moby/buildkit => github.com/macOScontainers/buildkit v0.0.0-20240226181538-d363e869a91d
)
